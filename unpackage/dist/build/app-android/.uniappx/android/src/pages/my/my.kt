...
open class GenPagesMyMy : BasePage {
        ...
        return _cE("view", _uM("class" to "container"), _uA(
            _cE("view", _uM("class" to _nC(_uA(
                ...
                _cE("view", _uM("class" to "user-avatar"), _uA(
                    _cE("image", _uM("class" to "avatar-img", "src" to (_ctx.userInfo.avatar || _ctx.defaultAvatarImage), "mode" to "aspectFill"), null, 8, _uA(
                        "src"
                    ))
                )),
                if (isTrue(_ctx.isLoggedIn)) {
                    _cE("view", _uM("key" to 0, "class" to "user-info"), _uA(
                        _cE("text", _uM("class" to "nickname"), _tD(_ctx.displayName), 1),
                        if (isTrue(_ctx.userInfo.phone)) {
                            _cE("text", _uM("key" to 0, "class" to "phone"), _tD(_ctx.userInfo.phone), 1)
                        } else {
                            _cC("v-if", true)
                        }
                    ))
            ...
            _cE("view", _uM("class" to "section menu-section"), _uA(
                ...
                _cE("view", _uM("class" to "menu-item", "onClick" to _ctx.goSettings), _uA(
                    _cE("image", _uM("class" to "menu-icon", "src" to "/static/icons/icon-settings.svg", "mode" to "aspectFit")),
                    _cE("text", _uM("class" to "menu-text"), "设置"),
                    _cE("text", _uM("class" to "menu-arrow"), "➜")
                ), 8, _uA(
                    "onClick"
                ))
    ...
    open var displayName: String by `$data`
    ...
    override fun data(): Map<String, Any?> {
        return _uM("isLoggedIn" to false, "defaultAvatarImage" to DEFAULT_AVATAR_IMAGE, "userInfo" to object : UTSJSONObject() {
            ...
            var phone = ""
            var avatar = ""
        }, "displayName" to computed<String>(fun(): String {
            val info = this.userInfo || UTSJSONObject()
            if (info.nickname) {
    ...
    open var goSettings = ::gen_goSettings_fn
    open fun gen_goSettings_fn() {
