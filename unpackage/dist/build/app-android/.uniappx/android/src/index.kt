...
open class CartItem1ReactiveObject : CartItem1, IUTSReactive<CartItem1> {
    ...
    override var __v_isShallow: Boolean
    override var __v_skip: Boolean
    constructor(__v_raw: CartItem1, __v_isReadonly: Boolean, __v_isShallow: Boolean, __v_skip: Boolean) : super(id = __v_raw.id, product_id = __v_raw.product_id, name = __v_raw.name, price = __v_raw.price, quantity = __v_raw.quantity, images = __v_raw.images, specs = __v_raw.specs, notes = __v_raw.notes) {
        this.__v_raw = __v_raw
        this.__v_isReadonly = __v_isReadonly
        this.__v_isShallow = __v_isShallow
        this.__v_skip = __v_skip
    ...
    override var specs: Any?
        get() {
            return _tRG(__v_raw, "specs", __v_raw.specs, __v_isReadonly, __v_isShallow)
        }
        set(value) {
            if (!__v_canSet("specs")) {
                return
            ...
            __v_raw.specs = value
            _tRS(__v_raw, "specs", oldValue, value)
        }
...
val GenPagesLegalAgreementClass = CreateVueComponent(GenPagesLegalAgreement::class.java, fun(): VueComponentOptions {
    return VueComponentOptions(type = "page", name = "", inheritAttrs = GenPagesLegalAgreement.inheritAttrs, inject = GenPagesLegalAgreement.inject, props = GenPagesLegalAgreement.props, propsNeedCastKeys = GenPagesLegalAgreement.propsNeedCastKeys, emits = GenPagesLegalAgreement.emits, components = GenPagesLegalAgreement.components, styles = GenPagesLegalAgreement.styles)
}
, fun(instance, renderer): GenPagesLegalAgreement {
    return GenPagesLegalAgreement(instance, renderer)
}
)
val GenPagesLegalPrivacyClass = CreateVueComponent(GenPagesLegalPrivacy::class.java, fun(): VueComponentOptions {
    return VueComponentOptions(type = "page", name = "", inheritAttrs = GenPagesLegalPrivacy.inheritAttrs, inject = GenPagesLegalPrivacy.inject, props = GenPagesLegalPrivacy.props, propsNeedCastKeys = GenPagesLegalPrivacy.propsNeedCastKeys, emits = GenPagesLegalPrivacy.emits, components = GenPagesLegalPrivacy.components, styles = GenPagesLegalPrivacy.styles)
}
, fun(instance, renderer): GenPagesLegalPrivacy {
    return GenPagesLegalPrivacy(instance, renderer)
}
)
...
val GenPagesSettingsPasswordClass = CreateVueComponent(GenPagesSettingsPassword::class.java, fun(): VueComponentOptions {
    return VueComponentOptions(type = "page", name = "", inheritAttrs = GenPagesSettingsPassword.inheritAttrs, inject = GenPagesSettingsPassword.inject, props = GenPagesSettingsPassword.props, propsNeedCastKeys = GenPagesSettingsPassword.propsNeedCastKeys, emits = GenPagesSettingsPassword.emits, components = GenPagesSettingsPassword.components, styles = GenPagesSettingsPassword.styles)
}
, fun(instance, renderer): GenPagesSettingsPassword {
    return GenPagesSettingsPassword(instance, renderer)
}
)
val GenPagesSettingsProfileClass = CreateVueComponent(GenPagesSettingsProfile::class.java, fun(): VueComponentOptions {
    return VueComponentOptions(type = "page", name = "", inheritAttrs = GenPagesSettingsProfile.inheritAttrs, inject = GenPagesSettingsProfile.inject, props = GenPagesSettingsProfile.props, propsNeedCastKeys = GenPagesSettingsProfile.propsNeedCastKeys, emits = GenPagesSettingsProfile.emits, components = GenPagesSettingsProfile.components, styles = GenPagesSettingsProfile.styles)
}
, fun(instance, renderer): GenPagesSettingsProfile {
    return GenPagesSettingsProfile(instance, renderer)
}
)
...
fun definePageRoutes() {
    ...
    __uniRoutes.push(UniPageRoute(path = "pages/register/register", component = GenPagesRegisterRegisterClass, meta = UniPageMeta(isQuit = false), style = _uM("navigationBarTitleText" to "注册")))
    ...
    __uniRoutes.push(UniPageRoute(path = "pages/order/detail", component = GenPagesOrderDetailClass, meta = UniPageMeta(isQuit = false), style = _uM("navigationBarTitleText" to "订单详情")))
    ...
    __uniRoutes.push(UniPageRoute(path = "pages/legal/agreement", component = GenPagesLegalAgreementClass, meta = UniPageMeta(isQuit = false), style = _uM("navigationBarTitleText" to "用户协议")))
    __uniRoutes.push(UniPageRoute(path = "pages/legal/privacy", component = GenPagesLegalPrivacyClass, meta = UniPageMeta(isQuit = false), style = _uM("navigationBarTitleText" to "隐私政策")))
    __uniRoutes.push(UniPageRoute(path = "pages/settings/settings", component = GenPagesSettingsSettingsClass, meta = UniPageMeta(isQuit = false), style = _uM("navigationBarTitleText" to "设置")))
    __uniRoutes.push(UniPageRoute(path = "pages/settings/password", component = GenPagesSettingsPasswordClass, meta = UniPageMeta(isQuit = false), style = _uM("navigationBarTitleText" to "修改密码")))
    __uniRoutes.push(UniPageRoute(path = "pages/settings/profile", component = GenPagesSettingsProfileClass, meta = UniPageMeta(isQuit = false), style = _uM("navigationBarTitleText" to "个人资料")))
}
