...
open class GenPagesIndexIndex : BasePage {
    ...
    override fun data(): Map<String, Any?> {
        return _uM("shop" to object : UTSJSONObject() {
            var name = "美味点餐"
            var logo = ""
            var description = "新鲜食材，用心烹饪"
            var opening_hours = "09:00-22:00"
            var is_open = true
            var announcement = ""
        }, "categories" to _uA<{
            var id: Number
